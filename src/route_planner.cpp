...
void RoutePlanner::AddNeighbors(RouteModel::Node *current_node) {
    ...
    for (RouteModel::Node *node : current_node -> neighbors){
      ...
      node -> g_value = node -> g_value + current_node -> distance(*node);
      node -> visited = true;
...
bool RoutePlanner::compare(RouteModel::Node *a, RouteModel::Node* b){
        float fa_val = a -> h_value + a -> g_value;
        float fb_val = b -> h_value + b -> g_value;
...
std::vector<RouteModel::Node> RoutePlanner::ConstructFinalPath(RouteModel::Node *current_node) {
    ...
    while (current_node -> parent != nullptr){
        //std::vector<RouteModel::Node>::iterator begin = path_found.begin();
